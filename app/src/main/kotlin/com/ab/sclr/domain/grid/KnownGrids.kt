...
enum class KnownGrids(val grid: Grid) {
        ...
        Grid(
            ...
            cells = listOf(
                ...
                Cell(
                    ...
                    rowSpan = 1,
                    columnSpan = 1
                )  // Second row, second cell (corrected from sample)
            )
        )
    ),
    ...
    TwoRows_70_30_TwoColumns_30_70_SwappedCellsWidth(
        Grid(
            id = "9",
            rows = listOf(
                Row(id = "R1", size = 0.5f),
            ...
            columns = listOf(
                Column(id = "C1", size = 0.34f),
                Column(id = "C2", size = 0.32f),
                Column(id = "C3", size = 0.34f)
            ),
            cells = listOf(
                Cell(id = "Cell1", startRow = 0, startColumn = 0, rowSpan = 1, columnSpan = 1),
                Cell(id = "Cell2", startRow = 0, startColumn = 1, rowSpan = 1, columnSpan = 2),
                Cell(id = "Cell3", startRow = 1, startColumn = 0, rowSpan = 1, columnSpan = 2),
    ...
    TwoRows_30_70_TwoColumns_70_30(
        Grid(
            id = "10",
            rows = listOf(
                Row(id = "R1", size = 0.34f),
                Row(id = "R2", size = 0.32f),
            ...
            cells = listOf(
                Cell(id = "Cell1", startRow = 0, startColumn = 0, rowSpan = 1, columnSpan = 1),
                Cell(id = "Cell2", startRow = 1, startColumn = 0, rowSpan = 2, columnSpan = 1),
                Cell(id = "Cell3", startRow = 0, startColumn = 1, rowSpan = 2, columnSpan = 1),
    ...
    TwoRows_50_50_ThreeColumns_33_33_34_CustomLayout18(
        Grid(
            ...
            columns = listOf(
                Column(id = "C1", size = 0.167f),
                Column(id = "C2", size = 0.166f),
                Column(id = "C3", size = 0.167f),
                Column(id = "C4", size = 0.167f),
                Column(id = "C5", size = 0.166f),
                Column(id = "C6", size = 0.167f),
            ),
            cells = listOf(
                Cell(
                    id = "Cell1",
    ...
    ThreeRows_33_33_34_TwoColumns_50_50_1(
        Grid(
            id = "23",
            rows = listOf(
                Row(id = "R1", size = 0.33f),
